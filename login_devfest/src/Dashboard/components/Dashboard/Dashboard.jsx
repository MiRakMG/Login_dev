    ...
    <main className={styles.container}>
      ...
      <div className={styles.charts}>
        <div className={styles.lines}>
          <Spline title="Program Plus" sales="4500,234" percentage="1.8" />
        </div>

        <div className={styles.lines}>
          <Spline title="Program Advanced" sales="5100,274" percentage="-1.2" />
        </div>

        <div className={styles.lines}>
          <Spline title="Program Professional" sales="1500,430" percentage="15" />
        </div>
